...
fn reserved_word_imported_alias() {
    assert_go!(
        (CURRENT_PACKAGE, "for", "pub fn class() { 1 }"),
        r#"import for.{class as for} as func
