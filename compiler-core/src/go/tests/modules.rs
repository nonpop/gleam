use crate::go::tests::CURRENT_PACKAGE;
use crate::{assert_go, assert_go_with_multiple_imports};
...
fn discarded_duplicate_import() {
    assert_go_with_multiple_imports!(
...
fn constant_module_access_with_keyword() {
    assert_go!(
        (CURRENT_PACKAGE, "rocket_ship", r#"pub const func = 1"#),
        r#"
import rocket_ship
